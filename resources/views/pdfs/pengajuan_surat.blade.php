...
<head>
    ...
    <style>
        ...
        .gov { font-weight: 700; }
        .area { font-size: 12px; }
        .surat { margin: 2px 0; font-size: 16px; font-weight: 700; }
        .no { font-size: 12px; }
        .double-line { border-top: 2px solid #000; border-bottom: 1px solid #000; margin: 2px 0 12px; }
        .content { margin: 0 36px; }
        .meta { margin-bottom: 12px; }
        .table { width: 100%; border-collapse: collapse; }
        .table td { padding: 6px 0; vertical-align: top; }
        .title { font-weight: 700; }
        .separator { border-top: 1px solid #000; margin: 4px 0 12px; }
...
<body>
    ...
    <div class="content">
        ...
        {{-- tampilkan field tambahan berdasarkan jenis surat --}}
        @php
            $additionalFields = $pengajuan->getAdditionalFields();
            $hasAdditionalFields = collect($additionalFields)->filter()->isNotEmpty();
        @endphp
