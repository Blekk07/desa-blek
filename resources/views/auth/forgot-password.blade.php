    ...
    <div class="card shadow-sm" style="max-width:420px; width:100%;">
        <div class="card-body p-4">
            <div class="text-center mb-3">
                ...
                <p class="text-muted small mb-0">Masukkan email Anda untuk mereset password.</p>
            </div>
            ...
            <form method="POST" action="{{ route('forgot_password.send_link') }}" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required class="form-control" placeholder="email@contoh.com" />
                    </div>
                </div>
